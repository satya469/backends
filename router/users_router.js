...
// player login
router.post("/login",configMiddleware.homeconfig,authMiddleware.ishost,UserCon.player_login);
...
router.post("/cgetlist",authMiddleware.isLoggedIn,UserCon.cgetlist)
...
// satta operators
router.post("/getsattaOperators",authMiddleware.isLoggedIn,UserCon.getsattaOperators)
router.post("/savesattaOperators",authMiddleware.isLoggedIn,UserCon.savesattaOperators)
router.post("/updatesattaOperators",authMiddleware.isLoggedIn,UserCon.updatesattaOperators)
router.post("/deletesattaOperators",authMiddleware.isLoggedIn,UserCon.deletesattaOperators)
...
router.post("/GetUserProfileLoad",authMiddleware.isLoggedIn,UserCon.GetUserProfileLoad)
router.post("/GetExposureList",authMiddleware.isLoggedIn,UserCon.GetExposureList)
router.post("/GetExposureTotal",authMiddleware.isLoggedIn,UserCon.GetExposureTotal)

router.post("/changepasswordhistory",authMiddleware.isLoggedIn,UserCon.changepasswordhistory)
