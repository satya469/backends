...
router.post("/getWalletMainuser2", authMiddleware.isLoggedIn,Dashboards.get_wallet_mainuser2);
...
router.post("/playerlistlimit",authMiddleware.isLoggedIn, Players.players_loadLimit);
router.post("/getdataSearch",authMiddleware.isLoggedIn, Players.getdataSearch);
...
// setexposure action
router.post("/setexposureaction", authMiddleware.isLoggedIn,  Players.setexposureaction);
// setexposure action
router.post("/setwininglimitaction", authMiddleware.isLoggedIn,  Players.setwininglimitaction);
// setexposure action
router.post("/setbetdelaytimeaction", authMiddleware.isLoggedIn, Players.setbetdelaytimeaction);
...
router.post("/multidelete",authMiddleware.isLoggedIn, Players.multidelete_action);
...
router.post("/playerget_accountstatement",authMiddleware.isLoggedIn,configMiddleware.sattaconfig,Players.playerget_accountstatement)
...
router.post("/getAllAgentForMove", Players.getAllAgentForMove); // this is for move player in player page
router.post("/changeAgentOfPlayer",authMiddleware.isLoggedIn, Players.changeAgentOfPlayer); // this is for move player in player page
