...
const RushpaymentControl = require("../controller/paymentController/rushpayment")
const pgcardpaymentControl = require("../controller/paymentController/pgcardpaymentcontrol")
...
// router.post("/getRate", Paygate10.getRate)
...
router.post("/rushpaymentcallback", RushpaymentControl.callback)
router.post("/rushpaymentCheckout", authMiddleware.isLoggedIn,RushpaymentControl.depositpaymentrequest)
router.post("/payoutrushpaymentcallback", RushpaymentControl.payoutrushpaymentcallback)


router.post("/paygcardpaymentCheckout", authMiddleware.isLoggedIn,pgcardpaymentControl.paygcardpaymentCheckout)
router.post("/paygcardpaymentGetTransactionStatus", authMiddleware.isLoggedIn,pgcardpaymentControl.paygcardpaymentGetTransactionStatus)
