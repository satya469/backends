...
const timecontrol = require("../controller/time")
...
router.post("/telegrammenuload",authMiddleware.isLoggedIn,CmsControll.telegrammenuload); 
...
router.post("/datatoexport",authMiddleware.isLoggedIn,timecontrol.csvfileexports)
