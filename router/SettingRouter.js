...
router.post("/getlngmenu",authMiddleware.isLoggedIn,SettingControl.getlngmenu);

router.post("/loadlagstore",authMiddleware.isLoggedIn,SettingControl.loadlagstore);
router.post("/createlagstore",authMiddleware.isLoggedIn,SettingControl.createlagstore);
router.post("/updatelagstore",authMiddleware.isLoggedIn,SettingControl.updatelagstore);
router.post("/deletelagstore",authMiddleware.isLoggedIn,SettingControl.deletelagstore);


router.post("/saveCurrencyOptions",SettingControl.saveCurrencyOptions);
router.post("/activeCurrency",SettingControl.activeCurrencyOptions);
router.post("/deleteCurrency",SettingControl.deleteCurrency);
router.post("/updateCurrency",SettingControl.updateCurrency);
router.post("/getCurrencyOptions",SettingControl.getCurrencyOptions);
router.post("/getPlatFormCurrency",SettingControl.getPlatFormCurrency);

//saveCurrencyOptions
// player side
router.post("/languageLoad",SettingControl.languageLoad);
