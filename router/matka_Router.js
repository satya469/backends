...
router.post("/RefreshResult",MatkaControll.RefreshResult);
router.post("/firstpageBazars",MatkaControll.firstpageBazars);
...
router.post("/icon1upload_bazartypes",multer({dest:config.BASEURL}).any(),BaseControll.imageupload,MatkaControll.icon1upload_bazartypes)
...
router.post("/createResultfromadmin",MatkaControll.admincreate_result)
router.post("/updateResultfromadmin",MatkaControll.updateResultfromadmin)

router.post("/update_result",authMiddleware.isLoggedIn,MatkaControll.update_result);
router.post("/delete_result",authMiddleware.isLoggedIn,MatkaControll.delete_result);
router.post("/get_renuve_frombazzar",authMiddleware.isLoggedIn,MatkaControll.get_renuve_frombazzar);
router.post("/revenCalc",authMiddleware.isLoggedIn,MatkaControll.revenCalc);
...
router.post("/findbazaars",MatkaControll.findbazaars)

router.post("/GetNewBazars",authMiddleware.isLoggedIn,MatkaControll.GetNewBazars)


router.post("/ScrapingResult",MatkaControll.ScrapingResult)
